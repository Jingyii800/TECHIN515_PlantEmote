...
import os
# Replace with your actual Azure IoT Hub connection string
CONNECTION_STRING = os.getenv("IOT_SEND_DATA_CONNECTION_STRING")

# Set up logging
logging.basicConfig(level=logging.INFO)

def send_image_url_to_iot_hub(image_url):
...
if __name__ == "__main__":
    # Example image URL
    image_url = "https://plantemot.blob.core.windows.net/plantemot/20240523231342_standard_plot.png"
    send_image_url_to_iot_hub(image_url)
